...
/** Default OpenAI API key when user has not set one in Settings. Leave empty to avoid committing secrets; users set smartdevide.models.openai.apiKey for out-of-the-box use. */
...
export const MODEL_PROVIDER_NAMES: Record<string, string> = {
    openai: 'OpenAI',
    anthropic: 'Anthropic',
    google: 'Google',
    cursor: 'Cursor',
