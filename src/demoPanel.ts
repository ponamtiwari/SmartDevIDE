...
import { DeveloperRole } from './roleManager';
import { backendTemplates } from './templates/backendRole';
import { frontendTemplates } from './templates/frontendRole';
import { qaTemplates } from './templates/qaRole';
import { techLeadTemplates } from './templates/techleadRole';
...
export class DemoPanel {
    ...
    private constructor(
        ...
        private readonly getCurrentRole: () => DeveloperRole
    ) {
        this.panel = panel;
    ...
    private sendCodeToWebview(commandType: string) {
    ...
    private getCodeForRoleAndCommand(role: DeveloperRole, commandType: string): string {
        let templates;
        ...
        switch (role) {
            ...
            case DeveloperRole.FRONTEND:
                ...
                break;
            case DeveloperRole.QA:
                templates = qaTemplates;
                break;
            case DeveloperRole.TECHLEAD:
                templates = techLeadTemplates;
                break;
            default:
                templates = backendTemplates;
        }
