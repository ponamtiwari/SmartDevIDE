...
These Markdown files are the source for the **GitHub Wiki** so they display at **https://github.com/poonamtiwari/smartdevide/wiki**.

## Option A: Push from repo (recommended – content shows at Wiki URL)

1. **Enable Wiki** on the repo: **Settings** → **Features** → check **Wiki**.
2. **Create the first page once** on GitHub so the wiki repo exists: open the [Wiki](https://github.com/poonamtiwari/smartdevide/wiki), click **Create the first page**, add any title (e.g. `Home`), paste **Home.md** content, save.
...
1. Open **https://github.com/poonamtiwari/smartdevide/wiki**
